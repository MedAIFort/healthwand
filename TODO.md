...
- [ ] **T-0001** `[BLOCKER][REPO-STATE]` Inspect current repo state. Capture `Cargo.toml`, `Cargo.lock` (if present), all CI workflows under `.github/workflows/`, full file tree (top 3 levels), and last-commit dates per major path. Output to `audit-2026-05.md` in a scratch branch.
